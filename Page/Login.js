...
import Screen from "../DrawerScreens/_layout";
    ...
    <View style={tw`flex-1 bg-orange-400`}>
      <SafeAreaView style={tw`flex bg-orange-400`}>
        <View style={tw`flex-row justify-start`}>
          <TouchableOpacity
            style={tw`bg-orange-400 p-2 rounded-tr-2xl rounded-bl-2xl ml-4 mt-2`}
      ...
      <View style={tw`flex-1 px-8 pt-8 mt-30 bg-white rounded-t-10`}>
        <View style={styles.css1}>
          ...
          <TextInput
            style={tw`p-4 bg-gray-100 text-gray-700 rounded-2xl mb-5 text-lg`}
          ...
          <TouchableOpacity
            style={tw`py-4 rounded-full bg-orange-400 my-8`}
            onPress={() => navigation.navigate("home")}
          >
            <Text style={tw` font-bold text-center text-white text-base`}>
